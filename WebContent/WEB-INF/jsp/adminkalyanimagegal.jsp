...
<section class="wrapper">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                              <form:form method="post" modelAttribute="adkalaim" action="saveadminkalaimg.html" enctype="multipart/form-data">
                                
                               
                               	<div class="col-md-3">

                                    <input type="file" name="adminkalafile" id="fileUpload" onchange="Upload();" value="" accept=".jpg,.png,jpeg" />
                                </div>
	...
	<div class="gallery">
		...
		<div class="gallery-grids">
				...
				<c:forEach var="kalaimg" items="${adminkalaimg}">
				<c:url var="deleteadminkala" value="deleteadminkala.html">
				<c:param name="delimgid" value="${kalaimg.image_id}"></c:param>
				<c:param name="delimgname" value="${kalaimg.image_name}"></c:param>
				</c:url>
					<div class="col-sm-4 gallery-grids">
					
					<a href="${deleteadminkala}"><i class="fa fa-trash" aria-hidden="true"></i></a>
						<div class="gallery-grid" style="width:450px;height:300px;">
							<a class="example-image-link" href="images/kalyannagarimages/${kalaimg.image_name }" data-lightbox="example-set" >
								<img src="images/kalyannagarimages/${kalaimg.image_name }" alt="" style="width: 70%;height: 90%;" />
