...
<%@ page import="com.appfone.stepperz.Daoimpl.KalyannagarimagesDaoimpl" %>
<!DOCTYPE html>
...
%>
	...
	<div class="gallery" id="gallery" width="50%"><br><br><br><br>
			&nbsp;&nbsp;&nbsp;&nbsp;<h3 class="title-w3" style="color:white;">Photo Gallery [Kalyan Nagar]</h3>
		 <p class="sub-text"></p>
		<%  
		KalyannagarimagesDaoimpl kalyan_img=new KalyannagarimagesDaoimpl();
		size=kalyan_img.getcount();
		kalyan_images=kalyan_img.getkalyannagarimages();
		for(int i=0;i<size;i++)
		{
			imgname=kalyan_images[i];
			imgpath="images/kalyannagarimages/"+imgname;
