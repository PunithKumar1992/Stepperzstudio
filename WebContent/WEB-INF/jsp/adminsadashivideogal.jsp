...
<section class="wrapper">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="position-center">
                              <form:form method="post" modelAttribute="adsadavideo" action="saveadminsadavid.html">
	...
	<div class="gallery">
		...
		<div class="gallery-grids">
				...
				<c:forEach var="sadavideo" items="${adminsadavlist}">
				<c:url var="admsadavideodel" value="admsadavideodel.html">
				<c:param name="video_id" value="${sadavideo.video_id}"></c:param>
				</c:url>
					<div class="col-sm-4 gallery-grids-left">
					<a href="${admsadavideodel}"><i class="fa fa-trash" aria-hidden="true"></i></a>
						<div class="gallery-grid">
									<iframe src="${sadavideo.video_link}"></iframe>
						</div>
					</div>
					</c:forEach>
