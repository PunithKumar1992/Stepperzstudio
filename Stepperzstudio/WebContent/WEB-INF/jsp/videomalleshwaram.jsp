...
<%@ page import="com.appfone.stepperz.Daoimpl.MalleshwaramvideoDaoimpl" %>
...
%>
	...
	<div class="gallery" id="gallery">
		<br><br><br><br><br><br><h3 class="title-w3" style="color:white;">Video Gallery [Malleshwaram]</h3><br><br>
		  <% 
		  MalleshwaramvideoDaoimpl mallesh_videolist= new MalleshwaramvideoDaoimpl();
		 size=mallesh_videolist.getcount();
		 malleshwaram_videos=mallesh_videolist.getMalleshwaramvideos();
		 for(int i=0;i<size;i++)
		 {
			 video_path=malleshwaram_videos[i];
			 		out.println("<center>");
