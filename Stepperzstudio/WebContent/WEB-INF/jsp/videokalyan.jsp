<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%@ page import="com.appfone.stepperz.Daoimpl.KalyannagarvideosDaoimpl" %>
...
%>
	...
	<div class="gallery" id="gallery" width="50%"><br><br><br><br>
		<br><br>	<h3 class="title-w3" style="color:white;">Video Gallery [Kalyan Nagar]</h3><br><br>
		 
		 <% 
		 KalyannagarvideosDaoimpl kalyan_videolist= new KalyannagarvideosDaoimpl();
		 size=kalyan_videolist.getcount();
		 kalyannagar_videos=kalyan_videolist.getKalyannagarvideos();
		 for(int i=0;i<size;i++)
		 {
			 video_path=kalyannagar_videos[i];
			 		out.println("<center>");
